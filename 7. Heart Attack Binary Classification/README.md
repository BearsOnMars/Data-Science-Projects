...
**In this project, Medical Health data is explored. The aim is to build a Binary Classification model that can predict whether a patient is at a high risk of heart attack or not, and to identify the most important features which contribute to a heart attack.**
